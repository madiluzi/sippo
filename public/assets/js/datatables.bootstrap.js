    ...
    "bootstrap": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                '<li class="first disabled"><a href="#" title="' + oLang.sFirst + '"><span class="fa fa-angle-double-left"></span></a></li>' +
                '<li class="prev disabled"><a href="#" title="' + oLang.sPrevious + '"><span class="fa fa-angle-left"></span></a></li>' +
                '<li class="next disabled"><a href="#" title="' + oLang.sNext + '"><span class="fa fa-angle-right"></span></a></li>' +
                '<li class="last disabled"><a href="#" title="' + oLang.sLast + '"><span class="fa fa-angle-double-right"></span></a></li>' +
                '</ul>'
            );
            var els = $('a', nPaging);
